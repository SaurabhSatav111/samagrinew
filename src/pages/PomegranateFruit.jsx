        ...
        <section id="contact" className="py-20 text-center border-t border-zinc-200" style={{ background: '#FAF7F2' }}>
          <div className="max-w-xl mx-auto px-6">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <a href="mailto:sales@samagrigroup.com" className="btn-primary-fruit">Request Spec & Quote</a>
              <a href="tel:+910000000000" className="btn-outline-fruit self-center">+91 00000 00000</a>
            </div>
          </div>
        </section>
      </div>
